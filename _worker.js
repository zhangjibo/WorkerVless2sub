...
// 设置优选地址api接口
let addressesapi = [
	'https://8747d58d.cf-workers-text2kv-2lz.pages.dev/ips-v4.txt?token=cc.,2015', //可参考内容格式 自行搭建。
...
let addressesnotlsapi = [
	'https://8747d58d.cf-workers-text2kv-2lz.pages.dev/result.csv?token=cc.,2015', //可参考内容格式 自行搭建。
];
